        ...
        <div class="col-sm-10"> <!-- Main Area -->
            ...
            <div class="table-responsive">
            	<table class="table table-striped table-hover">
					...
					$SrNo=0; 
					global $ConnectionDB;
					$CommentViewQuery="SELECT * FROM comments WHERE status='OFF' ORDER BY id desc";
					$Execute=mysql_query($CommentViewQuery);
            ...
            <div class="table-responsive">
            	<table class="table table-striped table-hover">
					...
					$CommentViewQuery="SELECT * FROM comments WHERE status='on' ORDER BY id desc";
					$Execute=mysql_query($CommentViewQuery);
					while($DataRows=mysql_fetch_array($Execute)){
						$CommentId = $DataRows['id'];
						$DateTimeofComment = $DataRows['datetime'];
                    ...
                    <tr>
                        ...
                        <td><a href="UnApproveComments.php?id=<?php echo $CommentId; ?>">
